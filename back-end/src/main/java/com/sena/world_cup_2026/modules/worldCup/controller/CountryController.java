...
public class CountryController
        extends AbstractController<CountryRequest, CountryResponse, CountryUpdate, Integer> {

    private final CountryService service;

    @Override
    protected CrudService<CountryRequest, CountryResponse, CountryUpdate, Integer> getService() {
        return service;
    }
}
